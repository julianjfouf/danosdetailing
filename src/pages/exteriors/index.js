...
const Index = () => {
  ...
  return (
    <>
      <Head>
        <title>Exterior Services in Tracy, CA</title>
        <meta
          name="description"
          content="The official Exterior Services page for all the information you need about services and packages offered in Tracy, CA."
        />
